...
// lưu
let heroInfojs = JSON.stringify(heroInfo);
localStorage.setItem("heroInfo", heroInfojs);
...
let personalDetailjs = JSON.stringify(personalDetail);
localStorage.setItem("personalDetail", personalDetailjs);
//--------------------------------------------------
let projects = [
  {
    id: 1,
...
let projectsjs = JSON.stringify(projects);
localStorage.setItem("projects", projectsjs);
