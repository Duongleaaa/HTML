...
// 1.Thêm mới công việc lên local.
// và hiển thị danh sách ra ngoài giao diện.
// 2. Khi click vào nút xóa thì hiển thị modal xác nhận xóa, nếu cancel thì không xóa ngược lại.
// 3. Sau khi click vào nút sửa thì hiển thị thông tin vào
// ô input và tiến hành sửa.
...
// ủy quyền sự kiện trong dom? về tìm hiểu.

//-------------------------------------------------------------------------------
// hàm map(). Dùng để lặp qua các phần tử của mảng, trả về một mảng mới có số lượng phần tử bằng
// số lượng phần tử mảng cũ nhưng đã bị thay đổi.
//ví dụ[1,2,3,4] ---> [2,4,6,8].

// về tìm hiểu những hàm code sẵn
